        ...
        <div style={styles.navTabs}>
          {[
            ...
            <button
              ...
              style={{
                ...styles.navTab,
                backgroundColor: currentTab === tab.key ? '#0066cc' : 'transparent',
                border: currentTab === tab.key ? 'none' : '1px solid #666666'
              }}
            >
              {tab.label}
            </button>
...
const styles = {
  ...
  nav: {
    backgroundColor: '#000000', padding: '0 24px', height: '60px',
    display: 'flex', justifyContent: 'space-between', alignItems: 'center',
    boxShadow: '0 2px 12px rgba(0,0,0,0.3)', position: 'sticky', top: 0, zIndex: 1000
  },
  navBrand: { display: 'flex', alignItems: 'center', gap: '10px' },
  navTitle: { color: 'white', fontWeight: '800', fontSize: '17px', letterSpacing: '1.5px' },
  navSubtitle: { color: '#0066cc', fontWeight: '500', fontSize: '13px' },
  ...
  userAvatar: {
    backgroundColor: '#0066cc', color: 'white', width: '34px', height: '34px',
  ...
  userRole: {
    color: '#0066cc', fontSize: '10px', fontWeight: '600',
    backgroundColor: 'rgba(0,102,204,0.15)', padding: '2px 6px', borderRadius: '4px'
  },
  logoutBtn: {
    backgroundColor: '#cc0000', border: '1px solid #cc0000', color: 'white',
  ...
  pageHeader: { marginBottom: '20px', borderBottom: '1px solid #cccccc', paddingBottom: '12px' },
  pageTitle: { margin: 0, color: '#000000', fontSize: '22px', fontWeight: '700' },
  pageDesc: { margin: '4px 0 0 0', color: '#666666', fontSize: '14px' }
};
